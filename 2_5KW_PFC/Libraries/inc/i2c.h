 ...
 *
 ******************************************************************************/
#define I2C_WriteByte(I2Cx,u8Data)          ((I2Cx)->I2CDATACMD.all = (((uint32_t)(u8Data)) & 0xFF))
 ...
 *
 ******************************************************************************/
#define I2C_ReadByte(I2Cx)                  ((uint8_t)((I2Cx)->I2CDATACMD.all & 0xFF))
...
/******************************************************************************
 * @brief      Enable I2C receive buffer full (reaches or goes above the threshold) interrupt
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     none
 *
 ******************************************************************************/
#define I2C_EnableRxDataAvailableInt(I2Cx)  ((I2Cx)->I2CIE.bit.RXDAV = I2CIE_BIT_RXDAV_ENABLE)




/******************************************************************************
 * @brief      Disable I2C receive buffer full (reaches or goes above the threshold) interrupt
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     none
 *
 ******************************************************************************/
#define I2C_DisableRxDataAvailableInt(I2Cx) ((I2Cx)->I2CIE.bit.RXDAV = I2CIE_BIT_RXDAV_DISABLE)
...
/******************************************************************************
 * @brief      Enable I2C transmit buffer empty (at or below the threshold) interrupt
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     none
 *
 ******************************************************************************/
#define I2C_EnableTxDataRequestInt(I2Cx)    ((I2Cx)->I2CIE.bit.TXDREQ = I2CIE_BIT_TXDREQ_ENABLE)




/******************************************************************************
 * @brief      Disable I2C transmit buffer empty (at or below the threshold) interrupt
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     none
 *
 ******************************************************************************/
#define I2C_DisableTxDataRequestInt(I2Cx)   ((I2Cx)->I2CIE.bit.TXDREQ = I2CIE_BIT_TXDREQ_DISABLE)
...
/******************************************************************************
 * @brief      Enable I2C transmit abort interrupt (Act as a master)
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     none
...
/******************************************************************************
 * @brief      Disable I2C transmit abort interrupt (Act as a master)
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     none
...
/******************************************************************************
 * @brief      Get I2C receive buffer full (reaches or goes above the threshold) interrupt status
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 ...
 *             in the I2CRXTH register and Self-cleared when level goes below threshold
 *
 ******************************************************************************/
#define I2C_GetRxDataAvailableIntFlag(I2Cx) ((I2Cx)->I2CIF.bit.RXDAV)
...
/******************************************************************************
 * @brief      Get I2C transmit buffer empty (at or below the threshold) interrupt status
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 ...
 *
 ******************************************************************************/
#define I2C_GetTxDataRequestIntFlag(I2Cx)   ((I2Cx)->I2CIF.bit.TXDREQ)




/******************************************************************************
 * @brief      Get I2C read request interrupt status (Act as a slave)
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
...
/******************************************************************************
 * @brief      Get I2C transmit abort interrupt status (Act as a master)
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
...
/******************************************************************************
 * @brief      Get I2C slave transmit done interrupt status (Act as a slave)
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
...
/******************************************************************************
 * @brief      Get I2C receive buffer full interrupt (reaches or goes above the threshold) raw status
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     1 or 0
 *
 ******************************************************************************/
#define I2C_GetRxDataAvailableIntRawFlag(I2Cx)  ((I2Cx)->I2CRAWIF.bit.RXDAV)
...
/******************************************************************************
 * @brief      Get I2C transmit buffer empty (at or below the threshold) interrupt raw status
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     1 or 0
 *
 ******************************************************************************/
#define I2C_GetTxDataRequestIntRawFlag(I2Cx)  ((I2Cx)->I2CRAWIF.bit.TXDREQ)




/******************************************************************************
 * @brief      Get I2C read request interrupt raw status (Act as a slave)
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     1 or 0
...
/******************************************************************************
 * @brief      Get I2C transmit abort interrupt raw status (Act as a master)
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     1 or 0
...
/******************************************************************************
 * @brief      Get I2C slave transmit done interrupt raw status (Act as a slave)
 *
 * @param[in]  I2Cx:  Select the I2C module
 *
 * @return     1 or 0
 ...
 *
 ******************************************************************************/
#define I2C_IsTxNotFull(I2Cx)               ((I2Cx)->I2CSTS.bit.TFNF)
 ...
 *
 ******************************************************************************/
#define I2C_IsTxEmpty(I2Cx)                 ((I2Cx)->I2CSTS.bit.TFE)
 ...
 *
 ******************************************************************************/
#define I2C_IsRxNotEmpty(I2Cx)              ((I2Cx)->I2CSTS.bit.RFNE)
 ...
 *
 ******************************************************************************/
#define I2C_IsRxFull(I2Cx)                  ((I2Cx)->I2CSTS.bit.RFF)
 ...
 *
 ******************************************************************************/
#define I2C_SetTxFIFOThreshold(I2Cx,u32TxLevel)   ((I2Cx)->I2CTXTH.all = (u32TxLevel) & 0xF)
 ...
 *
 ******************************************************************************/
#define I2C_SetRxFIFOThreshold(I2Cx,u32RxLevel)   ((I2Cx)->I2CRXTH.all = (u32RxLevel) & 0xF)
...
void I2C_MasterWrite(I2C_REGS* I2Cx, I2C_AddrModeEnum eAddrMode, uint16_t u16TargetAddr, uint8_t *pu8WriteBuffer, uint32_t u32Count);
void I2C_SlaveRead(I2C_REGS* I2Cx, uint8_t *pu8ReadBuffer, uint32_t u32Count);

void I2C_MasterRead(I2C_REGS* I2Cx, I2C_AddrModeEnum eAddrMode, uint16_t u16TargetAddr, uint8_t *pu8ReadBuffer, uint32_t u32Count);
void I2C_SlaveWrite(I2C_REGS* I2Cx, uint8_t *pu8WriteBuffer, uint32_t u32Count);

void I2C_MasterBulkWrite(I2C_REGS* I2Cx, I2C_AddrModeEnum eAddrMode, uint16_t u16TargetAddr, uint8_t *pu8WriteBuffer, uint32_t u32Count);
void I2C_SlaveBulkRead(I2C_REGS* I2Cx, uint8_t *pu8ReadBuffer, uint32_t u32Count);

void I2C_MasterBulkRead(I2C_REGS* I2Cx, I2C_AddrModeEnum eAddrMode, uint16_t u16TargetAddr, uint8_t *pu8ReadBuffer, uint32_t u32Count);
