 ...
 *
 ******************************************************************************/
#define CRC_EnableInt(CRCx)                 ((CRCx)->CRCIE.bit.DONE = CRCIE_BIT_DONE_ENABLE)
 ...
 *
 ******************************************************************************/
#define CRC_DisableInt(CRCx)                ((CRCx)->CRCIE.bit.DONE = CRCIE_BIT_DONE_DISABLE)
 ...
 *
 ******************************************************************************/
#define CRC_ClearInt(CRCx)                  ((CRCx)->CRCIC.all = CRCIC_ALL_DONE_CLEAR)
